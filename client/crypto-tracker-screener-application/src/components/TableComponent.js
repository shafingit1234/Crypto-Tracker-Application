...
const TableComponent = () => {
  /**
   * to avoid props drilling we can make use of context api.
   * We will need to create a context object using createContext,
   * Wrap all your components under context provider.
   * By wrapping, it allows component to use and subscribe all changes to context object.
   * Now we can fetch api, one time and share the fetched data easily by using useContext Hook, to components even if they are at different routes.
   */
                  ...
                  >
                    <td className="py-4 flex items-center uppercase">
                      <button className="outline-0 border-0 bg-none cursor-pointer">
                        ...
                        {/* Brought above code from star.svg file in assets folder */}
                      </button>
                      {/* bring image icon from data fetched */}
                      <img
                    ...
                    >
                      ...
                      {/* tofixed will show upto 2 decimal places*/}
                    </td>
                    <td
                      className={
